            ...
            <div className="ind-project-container">
              <Collapsible trigger={
                ...
                <p className="projects">
                  LevelUp was the first major application that I took through the entire software
                  development lifecycle. My team's goal was to create an application that would 
                  utilize our passion for Role Playing Games to develop useful skills in the real world.
                  With this concept in mind, and some careful planning, my team set out to create 
                  the self improvement app that would both entertain and motivate users; this was
                  the start of LevelUp's journey.<br/><br/>
                  ...
                  improving our plan at each stage. In the process I learned a ton about React Native,
