      ...
      <div className="profile-wrapper">
        ...
        <div>
          ...
          <img 
            src={uwLogo} 
            alt="UW-Madison"
            style={{height:"auto", width:"200px", margin: "auto"}}></img>
          

        </div>
        <div className="profile-links"> 
          <a href="https://github.com/henscheid" target="_blank" rel="noopener noreferrer">
          ...
          <a href="https://www.linkedin.com/in/ian-henscheid/" target="_blank" rel="noopener noreferrer">
