        ...
        <div className="experience-content">
          <div className="ind-experience-container" id="ssec-exp">
            ...
            <div className="exp-info">
              ...
              <br/>
              <p className="exp">
                After my freshman year of college I found myself with plenty of free time and
                decided I needed something else to fill out my schedule, so I scoured the University
                job page and stumbled upon a position at the Space Science and Engineering Center that
                seemed like it would be a good learning experience for me.
                <br/><br/>
          ...
          <div className="ind-experience-container" id="pcwp-exp">
            ...
            <div className="exp-info">
              ...
              <p className="exp">
                ...
                I started at Pollock as a way for me to keep busy during the summer, learn how 
                to manage my own schedule, and make some cash to put in my savings, but being a 
                ...
                <br/><br/>
                As a Head Lifeguard and manager I learned how to provide excellent customer service,
                problem solve on the spot, communicate with authority, and perhaps most importantly serve
                as a role model and mentor to a lot of high school students who were for the most part
                working their first job! I wouldn't trade my time at Pollock for anything, I think
                it really helped me grow as a person and gain valuable life skills.
              </p>
            </div>
